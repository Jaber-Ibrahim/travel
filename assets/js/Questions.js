...
function fetchQuestion() {
  let result = {"questions" : [
    ...
    {
      "question"       : "هل يمكنني حجز رحلة ذهاب او اياب فقط ؟",
      "answer" :  "يمكن ان يكون الحجز من سوريا الى الامارات فقط او العكس من الامارات الى سوريا (يسمى ذهاب فقط ) كما يمكن ان يكون الحجز من سوريا الى الامارات ثم من الامارات الى سوريا او العكس ( يسمى ذهاب وعودة )" ,
      "cat"    : "reservation",
      "lang"  : "ar"
  },
  {
    "question"       : "هل يوجد وجهات محددة لدى شركتكم أو يمكنني الحجز لوجهة محددة ؟",
    "answer" :  "كوننا وكلاء عدة خطوط طيران سوف يتم تقسيم الحجوزات الى فئتين:<br> الفئة الأولى: 1- بين سورية والامارات 2- من الامارات الى اكثر من 200 وجهة حول العالم<brالفئة الثانية: الى كافة انحاء العالم حيث نقوم بالحجز الاونلاين للمسافر ايا كانت الوجهة التي يريدها او خطوط الطيران التي يريد الحجز عن طريقها> ",
    "cat"    : "reservation",
    "lang"  : "ar"
},
{
  "question"       :  "ما هي المطارات التي يمكنني الحجز عن طريقها في سوريا ؟",
  "answer" :  "نستطيع تقديم خدمة الرحلات الجوية بين سوريا والامارات عبر مطارات المدن التالية :<br> دمشق – حلب - اللاذقية",
  "cat"    : "reservation",
  "lang"  : "ar"
},
{
  "question"       : "ما هي المطارات التي يمكنني الحجز عن طريقها في الإمارات ؟",
  "answer" :  "نستطيع تقديم خدمة الرحلات الجوية بين سوريا والامارات عبر مطارات المدن التالية : <br>  دبي – الشارقة – ابو ظبي",
  "cat"    : "reservation",
  "lang"  : "ar"
},
{
  "question"       :  "ما هي الأوراق المطلوبة للحجز في الإمارات ؟",
  "answer" :  "بالنسبة للمسافريين المتوجهين الى الامارات جواز سفر فيه صلاحية أكثر من ستة أشهر + الاقامة للمقيم و تأشيرة الدخول للزائر",
  "cat"    : "reservation",
  "lang"  : "ar"
},
{
  "question"       : "ما هو الوزن المتاح حمله معي ؟"  ,
  "answer" :  "عادة ما يكون الوزن المتاح للمسافر ٣٠ او ٢٠ كيلو غرام بالاضافة الى حقيبة يد وزنها ٧ كيلو غرام ويمكن اضافة وزن على الوزن الاساسي المتاح يمكنكم التواصل مع خدمة العملاء لمعرفة المزيد من التفاصيل. ",
  "cat"    : "reservation",
  "lang"  : "ar"
},
{
  "question"       :  "هل يمكنني الاطلاع على الأسعار ؟" ,
  "answer" :  "ان اسعار تذاكر الطيران تختلف باختلاف تاريخ الرحلة يمكنكم التواصل مع فريق خدمة العملاء لمساعدتكم بالاطلاع على الاسعار واختيار ما يناسبكم.",
  "cat"    : "reservation",
  "lang"  : "ar"
},
    {
    ...
    {
      "question"       :  "هل يمكنني معرفةالمزيد عن التأشيرات",
      "answer" :  "التأشيرات الرئيسية اللتي نقوم باصدارها هي التأشيرات الى دولة الامارات وهي ثلاث أنواع: <br>  1- تأشيرة السياحة ( دخول مرة واحدة ) : تعتبر تأشيرة السياحة أكثر أنواع التأشيرات طلبا في الامارات بنسبة تصل الى 90% تقريبا وهي من الخدمات الرئيسية التي سنقوم بتقديمها في شركة المختار. <br> 2- تأشيرة سياحية متعددة الدخول. <br> 3- تأشيرة زيارة عائلية." ,
      "cat"    : "visas",
      "lang"  : "ar"
  },
  {
    "question"       :  "كم يستغرق من الوقت حجز تأشيرة",
    "answer" :  "تستغرق حوالي يوم أو يومين عمل سواء كانت تأشيرة زيارة عائلي أو تأشيرة سياحية متعددة الدخول أو تأشيرة السياحة",
    "cat"    : "visas",
    "lang"  : "ar"
},
{
  "question"       :  "ما هي مدة صلاحية الفيزا ؟",
  "answer" :   "صلاحية استعمال الفيزا اول مرة (الدخول الى الامارات) تكون شهرين. <br> أما صلاحية الفيزا بعد الدخول تختلف اذا كانت التأشيرة سياحية تكون شهر او شهرين ( حسب طلب الزبون) <br> أما تأشيرة الزيارة العائلية تكون ثلاثة أشهر",
  "cat"    : "visas",
  "lang"  : "ar"
},
{
  "question"       :  "ما هي الأوراق المطلوبة لحجز تأشيرة ؟",
  "answer" :  "إذا كانت التأشيرة سياحية الأوراق المطلوبة هي: <br>  1- جواز السفر صالح لمدة اكثر من ست اشهر. 2- صورة شخصية. 3- صورة جواز السفر. <br> <br>  أما تأشيرة الزيارة العائلية الأوراق المطلوبة هي: <br>  1-جواز السفر صالح لمدة اكثر من ست اشهر. 2- صورة شخصية. 3- صورة جواز السفر. <br> عقد عمل للمضيف بمرتب 5000 درهم او اكثر. 5- اثبات صلة القرابة مصدق. 6- بيان عائلة او شهادة ميلاد او عقد زواج.",
  "cat"    : "visas",
  "lang"  : "ar"
},
{
  "question"       :  "هل يمكنني الاطلاع على أسعار التأشيرات ؟",
  "answer" :  " يمكنك التواصل مع فريق خدمة العملاء لاطلاعك على انواع واسعار التاشيرات المتاحة ومساعدتك باختيار ما يناسب حاجتك." ,
  "cat"    : "visas",
  "lang"  : "ar"
},
    {
    ...
    {
      "question"       :  "هل يمكنني طباعة وتقديم مسار الرحلة الذي تلقيته منك إلى السفارة ؟",
      "answer" :  "نعم. سنرسل لك مسار الرحلة عبر البريد الإلكتروني بتنسيق PDF ويمكنك فقط طباعته ونقله إلى السفارة لإظهاره كدليل على ترتيبات السفر.",
      "cat"    : "services",
      "lang"  : "ar"
  },
  {
    "question"       :  "ما مدى وثوقية خدمتك ولماذا يجب علي استخدامها ؟",
...
{
  "question"       :  "هل هناك أي عمليات إلغاء للتذاكر يتعين عليّ اجراؤها بعد حصولي على التأشيرة ؟ إذا كان الأمر كذلك , فهل هناك رسوم إلغاء ؟",
  "answer" :  "نحن نتولى جميع عمليات إلغاء الحجوزات نيابة عنك. لا داعي للقلق بشأن أي رسوم إلغاء إضافية أو أي شيء. ما تدفعه هو مجرد رسوم خدمة لإجراء حجز طيران أو فندق. بمجرد حصولك على التأشيرة ، ضع خطط السفر الخاصة بك ، واسترخ واستمتع برحلتك!",
  "cat"    : "services",
  "lang"  : "ar"
},
{
  "question"       :  "ما هي التفاصيل التي تحتاجها مني لتقديم طلب حجز طيران وحجز فندق ؟",
  "answer" :  "نحن لا نطلب أي معلومات سرية. كل ما نحتاجه هو <br>  1. اسمك الكامل  <br> 2. تفاصيل السفر الأساسية الخاصة بك للرحلات (مدينة المغادرة ، مدينة الوصول ، تواريخ المغادرة) والفنادق (المدينة ، مواعيد تسجيل الوصول والمغادرة)",
  "cat"    : "services",
  "lang"  : "ar"
},
    
  ]};
  let myQuestions = result.questions;
  console.log(myQuestions)
  let myFilteredItems = [];
  myLisToFilter.forEach((li) => {
    myQuestions.forEach((question) => {
      if (li.classList.contains("active") && question.cat.includes(li.dataset.cat) && document.body.classList.contains(`${question.lang}`)) {
    ...
    li.addEventListener("click", () => {
      ...
      myQuestions.forEach((question) => {
        if (question.cat.includes(li.dataset.cat) && document.body.classList.contains(`${question.lang}`)) {
          myFilteredItems.push(question);
        } 
      });
